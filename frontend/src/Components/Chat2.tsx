...
const ChatDialog2: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { id: 1, sender: 'Grimble', text: 'Hey, how are you?' },
    { id: 2, sender: 'You', text: 'Hi Grimble! I\'m doing great, thanks for asking. How about you?' },
  ]);
  ...
  const handleSendMessage = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setNewMessage('');
    setCurrentSender(currentSender === 'Alice' ? 'Bob' : 'Alice');
  };
